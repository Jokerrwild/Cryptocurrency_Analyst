...
*   **Report ID**: `936507db-3d68-4f8d-8e92-baabd0b323a6`
*   **Generated Timestamp (UTC)**: 2026-05-25T03:19:41.138117+00:00Z
...
### **Executive Summary**
*   **Date/Time (US EDT) of the analysis**: 2026-05-24 11:19:41 PM EDT
...
*   **Recommendation (HOLD / BUY / SELL) currency**: <b>HOLD (Wait for conviction)</b>
    ...
    *   *Market Trend Probability*: Neutral consolidation (31.2% probability)


### **Market Thesis**
Leading regime is classified as *Neutral consolidation* with a posterior probability weight of *31.2%*.

### **Probability Table**
```text
Market Regime                  | Probability | Confidence
----------------------------------------------------------
Neutral consolidation          | 31.2%       | Medium    
Bullish accumulation           | 13.4%       | Low       
...
* Trend score: +0.058 (positive = above EMA-50)
...
*   Momentum [XRP]: -0.013
*   Momentum [SOL]: -0.018
* BTC Indicators: RSI=54.5, EMA20=$76,715.41, EMA50=$76,539.29, 24h=-0.03%, 5d=+0.01%, VolConf=0.07
...
### **Interpretation**
Leading regime is 'Neutral consolidation' with posterior probability 31.2% (confidence: Medium). Trend signal is positive (+0.06) and momentum is building (+0.02). Treat this as a probabilistic belief state, not a deterministic prediction.
...
----------------------------------------------------------
1    | BTC    | $76,985.93   | +0.018     | 0.0% (HOLD)    
