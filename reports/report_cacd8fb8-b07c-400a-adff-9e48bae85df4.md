...
*   **Report ID**: `cacd8fb8-b07c-400a-adff-9e48bae85df4`
*   **Generated Timestamp (UTC)**: 2026-05-25T03:00:49.804288+00:00Z
*   **Interval Label**: 3-Hourly Scheduled Pulse
*   **BTC Spot Price**: $77,069.03 USD
*   **ETH Spot Price**: $2,094.75 USD
*   **SOL Spot Price**: $84.94 USD
*   **XRP Spot Price**: $1.35 USD

### **Executive Summary**
*   **Date/Time (US EDT) of the analysis**: 2026-05-24 11:00:49 PM EDT
...
*   **Recommendation (HOLD / BUY / SELL) currency**: <b>HOLD (Wait for conviction)</b>
    *   *Key Macro Indicators*: SPY=$745.64, QQQ=$717.54, DXY=99.01, US10Y=0.00%
...
----------------------------------------------------------
Neutral consolidation          | 33.0%       | Medium    
Bullish accumulation           | 12.2%       | Low       
...
* Volume score: 0.006 (0.5=avg, 1.0=2x avg)
...
### **Interpretation**
Leading regime is 'Neutral consolidation' with posterior probability 33.0% (confidence: Medium). Trend signal is negative (+0.00) and momentum is waning (+0.00). Treat this as a probabilistic belief state, not a deterministic prediction.
...
----------------------------------------------------------
1    | BTC    | $77,069.03   | +0.000     | 0.0% (HOLD)    
