...
*   **Report ID**: `ce171960-39d5-4484-b4c2-7ec6f1889a20`
*   **Generated Timestamp (UTC)**: 2026-05-27T15:00:19.836767+00:00Z
*   **Interval Label**: 3-Hourly Scheduled Pulse
*   **BTC Spot Price**: $74,896.28 USD
*   **ETH Spot Price**: $2,058.09 USD
*   **SOL Spot Price**: $83.71 USD
*   **XRP Spot Price**: $1.33 USD
*   **USD1 Spot Price**: $1.00 USD
*   **HYPE Spot Price**: $60.06 USD
*   **BNB Spot Price**: $652.87 USD
*   **NEAR Spot Price**: $2.55 USD
*   **ZEC Spot Price**: $566.89 USD
*   **DOGE Spot Price**: $0.10 USD

### **Executive Summary**
*   **Date/Time (US EDT) of the analysis**: 2026-05-27 11:00:19 AM EDT
...
*   **Recommendation (HOLD / BUY / SELL) currency**: <b>RULE-BASED HOLD (Conviction below threshold)</b>
    *   *Key Macro Indicators*: SPY=$749.70, QQQ=$727.04, DXY=99.10, US10Y=4.48%
    *   *Market Trend Probability*: Bullish accumulation (37.6% probability)


### **Market Thesis**
Leading regime is classified as *Bullish accumulation* with a posterior probability weight of *37.6%*.

### **Probability Table**
```text
Market Regime                  | Probability | Confidence
----------------------------------------------------------
Bullish accumulation           | 37.6%       | Medium    
Neutral consolidation          | 22.3%       | Low       
Bullish continuation           | 12.9%       | Low       
Macro-driven risk-off          | 9.8%        | Low       
High-volatility transition     | 9.4%        | Low       
Bearish continuation           | 4.4%        | Low       
Bearish distribution           | 3.5%        | Low       
```
...
* Macro support: -0.052 (equity trend minus DXY drag)
*   Momentum [HYPE]: +0.014
*   Momentum [DOGE]: +0.000
*   Momentum [USD1]: -0.002
*   Momentum [BNB]: -0.022
...
* SOL Indicators: RSI=43.4, EMA20=$83.85, EMA50=$84.29, 24h=+0.28%, 5d=-0.14%, VolConf=1.00
...
* HYPE Indicators: RSI=45.8, EMA20=$61.34, EMA50=$61.23, 24h=-1.22%, 5d=-3.93%, VolConf=0.72
* BNB Indicators: RSI=32.8, EMA20=$654.27, EMA50=$656.16, 24h=+0.19%, 5d=-0.14%, VolConf=1.00
...
* DOGE Indicators: RSI=47.4, EMA20=$0.10, EMA50=$0.10, 24h=+0.09%, 5d=-0.06%, VolConf=0.80
...
### **Interpretation**
Leading regime is 'Bullish accumulation' with posterior probability 37.6% (confidence: Medium). Trend signal is negative (-0.16) and momentum is waning (-0.04). Treat this as a probabilistic belief state, not a deterministic prediction.
...
----------------------------------------------------------
1    | HYPE   | $60.06       | +0.014     | 0.0% (HOLD)    
2    | DOGE   | $0.10        | +0.000     | 0.0% (HOLD)    
3    | USD1   | $1.00        | -0.002     | 0.0% (HOLD)    
4    | BNB    | $652.87      | -0.022     | 0.0% (HOLD)    
5    | SOL    | $83.71       | -0.022     | 0.0% (HOLD)    
```
